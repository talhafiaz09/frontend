  ...
  UNSAFE_componentWillMount() {
    ...
    if (this.props.filteredResults != null) {
      ...
      for (var q = 0; q < this.props.filteredResults.length; q++) {
        ...
        this.state.meal_type.push(this.props.filteredResults[q].mealtype);
        this.state.cuisine_type.push(this.props.filteredResults[q].cuisine);
        this.state.user_email.push(this.props.filteredResults[q].useremail);
        this.state.timerequired.push(
